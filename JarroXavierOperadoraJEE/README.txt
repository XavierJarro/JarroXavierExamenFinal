...
a persistence unit "JarroXavierOperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "JarroXavierOperadoraJEE\pom.xml":
...
artifact ("JarroXavierOperadoraJEE.war") is already built. You can build
