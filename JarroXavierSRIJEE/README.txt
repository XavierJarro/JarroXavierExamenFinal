...
a persistence unit "JarroXavierSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "JarroXavierSRIJEE\pom.xml":
...
artifact ("JarroXavierSRIJEE.war") is already built. You can build
