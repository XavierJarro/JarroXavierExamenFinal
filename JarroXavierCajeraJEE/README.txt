...
a persistence unit "JarroAguirreCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "JarroAguirreCajeraJEE\pom.xml":
...
artifact ("JarroAguirreCajeraJEE.war") is already built. You can build
